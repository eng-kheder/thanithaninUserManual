  ...
  return (
    <PageShell>
      <PageHero
        ...
        title="عقود الإيجار"
        tagline="إيجار المحلّ من أكبر المصروفات الثابتة. هذا الموديول يحوّله من مصروف يُسجَّل في الوقت غير المناسب إلى التزام شهري واضح بقيود تلقائية وتذكيرات قبل الاستحقاق."
      />
      ...
      <Callout tone="info" title="ميّزة بسيطة لكنها تحمي">
        <p className="mb-0">
          في كثير من المحلّات، يُسجَّل الإيجار عند دفعه فقط، فيصبح الشهر الذي
