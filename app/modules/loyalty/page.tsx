      ...
      <section className="mb-10 rounded-2xl border border-brand-200 bg-gradient-to-br from-brand-50 to-white p-6 sm:p-8">
        <div className="mb-3 flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-brand-600">
            لماذا نقاط الولاء في صيدلية؟
          </span>
        </div>
        <p className="max-w-3xl text-[15px] leading-8 text-ink-600">
          الدواء ليس منتجاً يُشترى مرّة واحدة. علاج الضغط، السكري، الفيتامينات،
          احتياجات الأطفال، مستحضرات التجميل — كلها مشتريات متكرّرة. من يختار
          صيدليته اليوم يعود إليها لسنوات. نقاط الولاء ترسّخ هذا الاختيار،
          وتحوّل العميل من «زيارة عابرة» إلى «علاقة مستمرّة».
        </p>
      </section>
      ...
      <FeatureGrid
        ...
        features={[
          ...
          },
          {
            icon: Tag,
            title: "أصناف مستثناة",
            body: "بعض الأصناف قد لا تستحقّ نقاطاً (مثل الأدوية المدعومة أو منتجات التأمين). حدّدها واستبعدها من حساب النقاط.",
          },
          {
            icon: CalendarClock,
            title: "صلاحية النقاط",
