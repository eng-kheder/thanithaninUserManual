  ...
  return (
    <PageShell>
      <PageHero
        ...
        tagline="نظام صلاحيات دقيق يضبط من يرى ماذا ومن يفعل ماذا. الكاشير لا يرى تكلفة الشراء، المحاسب لا يفتح جلسة بيع، مدير الفرع يرى فرعه فقط. حماية الأعمال تبدأ من هنا."
      />
        ...
        features={[
          {
            ...
            body: "المالك، المدير العام، المحاسب، مدير الفرع، الكاشير، البائع، موظف المستودع، فنيّ الصيانة. لكل دور مجموعة صلاحيات افتراضية، قابلة للتعديل.",
          },
          {
            icon: Layers,
            title: "دور لكل مستوى",
      ...
      <FeatureGrid
        ...
        features={[
          ...
          },
          {
            icon: Lock,
            title: "صلاحيات حذف",
            body: "الحذف يتطلّب صلاحيات مستقلّة عن الإنشاء والتعديل — في المحلّ، قلّة تحذف وأغلبية تُعدّل.",
          },
          {
            icon: Building,
      ...
      <Callout tone="tip" title="مثال عمليّ">
        <p className="mb-0">
          البائع على نقطة البيع يستطيع البيع، لكن الخصم فوق 10% يحتاج موافقة
        ...
        features={[
          {
            ...
            body: "إذا كنت تدير محلّين بسجلّين تجاريين مختلفين، يمكنك إدارتهما في نفس النظام بفصل محاسبي كامل لكل شركة.",
          },
          {
            icon: Layers,
      ...
      <p className="mb-6 max-w-3xl text-[15px] leading-8 text-ink-500">
        النظام يدعم نماذج استخدام متدرّجة: محلّ صغير بفرع واحد، سلسلة
