  ...
  return (
    <PageShell>
      <PageHero
        ...
        tagline="الرفوف، الفترينات، أجهزة نقاط البيع، أدوات الصيانة، السيارات، الأثاث — كل ما يشتريه المحلّ ويبقى معه لأكثر من سنة. موديول الأصول الثابتة يتابع دورة حياتها من الشراء إلى الاستبعاد، ويحتسب استهلاكها شهرياً دون تدخّل يدوي."
      />
