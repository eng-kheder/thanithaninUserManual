...
export const metadata = {
  ...
  description:
    "إدارة فروع المحلّ: كل فرع بمستودعاته، خزائنه، موظفيه، ومبيعاته — في نظام موحّد بتقارير مقارنة.",
};
  ...
  return (
    <PageShell>
      <PageHero
        ...
        eyebrow="محلّ واحد أو عشر فروع"
        title="الفروع"
        tagline="سواء كان محلّاً واحداً أو شبكة من الفروع، ثاني اثنين يدير كل فرع باستقلاليته — مستودعه، خزينته، موظفوه، عملاؤه — مع إبقاء صورة موحّدة للإدارة العليا."
      />
