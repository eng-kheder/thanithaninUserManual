  ...
  return (
    <PageShell>
      <PageHero
        ...
        tagline="كل ريال يدخل الصيدلية أو يخرج منها يمرّ من هنا. الخزائن لنقد الفروع، الحسابات البنكية للتحويلات، سندات القبض والصرف للموثّقة، والشيكات بدورة حياتها الكاملة — كل ذلك مرتبط تلقائياً بالمحاسبة وذمم العملاء والموردين."
      />
