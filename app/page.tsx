  ...
  return (
    <PageShell>
      <PageHero
        ...
        tagline="هذا الدليل يعرض جميع الخدمات والميزات المتوفرة في النظام، مقسّمة حسب الموديولات، بحيث تتعرف على ما يقدمه النظام لك قبل أن تبدأ استخدامه. يُقرأ من البداية بالترتيب، أو ينتقل المستخدم مباشرة إلى الموديول الذي يهمه من القائمة."
      />
      ...
      <section className="mb-10 rounded-2xl border border-brand-100 bg-gradient-to-br from-brand-50 to-white p-6 sm:p-8">
        ...
        <p className="max-w-3xl text-[15px] leading-8 text-ink-600">
          ...
          — لأن هاتين المعلومتين هما ما يفرق بين صيدلية آمنة وصيدلية
          معرّضة للخسائر والمخالفات.
        </p>
        <div className="mt-5 flex flex-wrap gap-2">
          ...
          <Link href="/modules/inventory/" className="btn-ghost">
            اذهب مباشرة إلى المخزون والدفعات
          </Link>
        </div>
      </section>
      ...
      <div className="mb-8 prose-guide">
        ...
        <p>
          كل موديول يشرح ما يقدمه النظام في هذا الجانب، والقيمة التي يحققها
          للصيدلية، وأبرز الميزات المتوفرة. الهدف أن يكون الدليل كافياً لتكوين
